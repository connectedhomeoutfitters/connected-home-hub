...
const ALLOWED_UNSCOPED = {
  ...
  'routes/webhooks.js': 'Stripe/Square/lead webhooks arrive with no session; org resolved from the row',
  'services/paymentsSync.js': 'refund reconciliation resolves the org from the processor payment id',
